  ...
  return (
    <div className="flex-1 flex items-center justify-center p-grid-margin">
      <div className="w-full max-w-md text-center flex flex-col items-center">
        <div className="mb-6 w-16 h-16 bg-error-container/60 flex items-center justify-center rounded-2xl text-error">
        ...
        {onRetry && (
          <button
            onClick={onRetry}
            className="px-6 py-2.5 bg-primary text-on-primary font-bold rounded-full hover:opacity-90 transition-all shadow-soft"
          >
            Retry
          </button>
        )}
