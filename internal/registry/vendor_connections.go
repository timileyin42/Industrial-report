...
// vendor_connections.encrypted_credential — a password-form vendor's
// login. OAuth-token vendors (none implemented yet) would store their
// token here instead once added.
